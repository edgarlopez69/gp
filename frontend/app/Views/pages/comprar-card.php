<div class="comprar-div">
    <h1 class="titulo">Comprar con tarjeta de credito</h1>
    <div class="data">
    ...
    <div class="" id="p-1">
        <div class="row  button-row">
            ...
            <div class="col">
                <button type="button" class="btn btn-success" onclick="pageTwo()">Continuar</button>
            </div>
        </div>
    </div>
    <div class="" id="p-2">
        ...
        <div class="row  button-row">
            <div class="col">
                <button type="button" class="btn btn-secondary" onclick="pageOne()">Regresar</button>
            </div>
            <div class="col">
                <button type="button" class="btn btn-success" onclick="pageThree()">Continuar</button>
            </div>
        </div>
    </div>    
    <div class="" id="p-3">
    	<div class="final-text-div">
    		<span class="final-text">
    			Por favor asegurese que la informacion sea correcta y completa.
    		</span>
    	</div>
        <div class="row button-row">
            <div class="col">
                <button type="button" class="btn btn-secondary" onclick="pageTwo()">Regresar</button>
            </div>
            <div class="col">
                <button type="button" class="btn btn-success" id="comprar-card">Comprar</button>
            </div>
        </div>
    </div>
</div>