...
<div style="margin-right: auto;
	...
	<p>
		Para seguir el proceso de compra es necesario contactar al equipo de ventas de Glass protech. Finalicé el proceso de envio con el siguiente numero de referencia: <?php echo $ide; ?>
	</p>
	<p>
